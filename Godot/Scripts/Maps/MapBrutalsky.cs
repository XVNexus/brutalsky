...
public class MapBrutalsky : MapGenerator
{
    public override BsMap Generate()
    {
        ...
        result.Nodes.Add(BsNode.ConstantFloat("positive", 1f));
        result.Nodes.Add(BsNode.ConstantFloat("negative", -1f));
        ...
        result.Links.Add(new BsLink("positive", 0, "motor-left-controller", 1));
        result.Links.Add(new BsLink("speed-selector", 0, "motor-right-controller", 0));
        result.Links.Add(new BsLink("negative", 0, "motor-right-controller", 1));
        result.Links.Add(new BsLink("motor-left-controller", 0, "spinner-left-motor", 5));
        result.Links.Add(new BsLink("motor-right-controller", 0, "spinner-right-motor", 5));
