...
public static class MathfExt
{
    ...
    public static Rect2 Clamp(Rect2 rect, Rect2 bounds)
    {
        ...
        var max = Min(rect.Position + rect.Size, bounds.Position + bounds.Size);
    ...
    public static Vector2 Clamp(Vector2 vector, Rect2 bounds)
    {
        return new Vector2
        (
            Mathf.Clamp(vector.X, bounds.Position.X, bounds.GetCorner().X),
            Mathf.Clamp(vector.Y, bounds.Position.Y, bounds.GetCorner().Y)
        );
    }
