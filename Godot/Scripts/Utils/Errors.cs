...
public static class Errors
{
    ...
    public static InvalidOperationException RegisterActivePlayer(string playerId)
        => new($"Player '{playerId}' is already active and cannot be registered again");

    public static InvalidOperationException UnregisterInactivePlayer(string playerId)
        => new($"Player '{playerId}' is already inactive and cannot be unregistered again");
