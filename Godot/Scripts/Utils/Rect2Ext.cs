...
{
    public static Vector2 GetCorner(this Rect2 _)
    {
    ...
    public static Rect2 ForceAspect(this Rect2 _, float aspect, bool minifyOrMaxify = true)
    {
        ...
        return new Rect2(new Vector2(_.Position.X - (newSize.X - _.Size.X) * .5f,
            _.Size.Y - (newSize.Y - _.Size.Y) * .5f), newSize);
    }
    ...
    {
        return new Rect2(_.Position.X - growth, _.Position.Y - growth,
            _.Size.X + growth * 2f, _.Size.Y + growth * 2f);
    }
}
